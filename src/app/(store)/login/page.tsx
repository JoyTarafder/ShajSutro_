      ...
      <div className="w-full max-w-6xl bg-white rounded-3xl shadow-[0_30px_90px_rgba(10,35,24,0.06)] border border-stone-200/70 overflow-hidden grid grid-cols-1 lg:grid-cols-12 relative z-10 min-h-[640px]">
        ...
        <div className="lg:col-span-7 p-8 sm:p-12 lg:p-14 flex flex-col justify-between bg-white relative">
          ...
          <div className="mt-10 pt-6 border-t border-stone-100 flex items-center justify-between text-xs text-stone-500 font-light">
            ...
            >
              <ChevronLeft className="w-3.5 h-3.5 transition-transform group-hover:-translate-x-0.5" strokeWidth={1.75} />
              Explore Collection
            </Link>
  ...
  return (
    <div className="mb-6">
      <button
        ...
        className="w-full flex items-center justify-center gap-2.5 px-4 py-3.5 rounded-2xl border border-stone-200/80 bg-stone-50/50 hover:bg-stone-100 hover:border-stone-300 text-xs sm:text-sm font-semibold text-stone-800 transition-all duration-200 disabled:opacity-60 active:scale-[0.98] shadow-2xs cursor-pointer"
      >
        {googleLoading ? (
...
function Spinner() {
  return <Loader2 className="animate-spin mx-auto h-5 w-5 text-white" />;
}
